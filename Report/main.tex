...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.8\textwidth}{\centering \vspace{2cm} PLACEHOLDER: System Architecture Diagram \vspace{2cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.8\textwidth}{\centering \vspace{2cm} PLACEHOLDER: State Machine Diagram \vspace{2cm}}}
    \caption{Sơ đồ chuyển đổi trạng thái FSM}
